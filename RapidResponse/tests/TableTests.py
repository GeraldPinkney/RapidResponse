...
class TableTestCase(unittest.TestCase):
    ...
    def test_table_repr(self):
        ...
        #print(part)
        self.assertEqual("Table(name='Mfg::Part', fields=[], type='input', keyed='Y', identification fields=None)",part.__str__())
    ...
    def test_add_col(self):
        ...
        #print(part)
        self.assertEqual("Table(name='Mfg::Part', fields=[Column(name='Column1', datatype='string', key='N'), Column(name='Column2', datatype='string', key='N')], type='input', keyed='Y', identification fields=None)",part.__str__())
...
class DataModelTestCase(unittest.TestCase):
    ...
    def test_table_data_model(self):
        data_model = DM.DataModel('C:\\Users\\gpinkney\\PycharmProjects\\RapidResponse\\RapidResponse\\RapidResponse\\DataModel')
        data_model.load_table_data_from_file('C:\\Users\\gpinkney\\PycharmProjects\\RapidResponse\\RapidResponse\\RapidResponse\\DataModel\\Tables.tab')
        col1 = RapidResponse.RapidResponse.Table.Column('Column1', 'string', 'N')
        col2 = RapidResponse.RapidResponse.Table.Column('Column2', 'string', 'N')
